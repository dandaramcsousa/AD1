...
Nesta análise será feito um agrupamento de dados com múltiplas variáveis utilizando o algoritmo k-means, os dados que serão utilizados e separados em grupos são sobre a quantidade de falas de personagens de diferentes gêneros em filmes de hollywood.
