...
3. A mediana idade do personagem
...
agrupamento = subset(dados,select = -c(lines_data, imdb_id, Palavras, Personagem,epp,fpp, Idade, Genero))
agrupamento = subset(agrupamento,!duplicated(agrupamento$script_id))
