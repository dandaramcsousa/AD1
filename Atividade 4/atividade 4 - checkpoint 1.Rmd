...
Vamos observar um pouco sobre quem são nossos dados. Primeiro podemos observar o quão bem distribuído estão os filmes no decorrer dos anos, temos filmes pratiacamento durante todo o intervalo de tempo. E, também, podemos ver a presença do gênero [] mais forte na nossa base de dados.
...
### 4. Relação gênero, idade e quantidade de fala
