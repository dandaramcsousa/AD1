...
Temos, aqui, uma amostra dos commits dados no GitHub no período 2016-2017. É possível observar a quantidade de pessoas que editaram arquivos de uma determinada extensão durante os dois anos.
...
Observando que md e js são as extensões mais populares da nossa amostra as utilizaremos para fins de análise. Primeiro vamos preparar os dados para nossa análise facilitando a relação de data e dia da semana.
...
md1 = md %>% 
  ...
  labs(title = "Edições por Dia da Semana (Java)", x = "Dia da Semana" , y= "Usuários que Fizeram Edições")
...
A partir dos gráficos é fácil perceber a diferença de popularidade de uma linguagem durante os dias úteis e finais de semana. A diferença é grande a ponto de ser facilmente percepitível.